...
From a dataframe with onlt the three arguments stated above we can get an initial PRISMA diagram.
...
By default this dataframe has 3 arguments:
    ...
    2. nodeType: This descibes the type of node it is.
...
## Changing FonstSize
We can add the fontSize argument to the datatable to cusomize the fontsize in each node.
